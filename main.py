...
class ModelViewerWindow(QtWidgets.QDialog):
    def __init__(self, model):
        ...
        self.textEdit = QtWidgets.QPlainTextEdit()
        self.textEdit = ModelEditor.CodeEditor()
...
class Window(QtWidgets.QWidget):
    ...
    def launchInstagramCommenterWindow(self):
        self.instagramCommenter = InstagramAutomator.ProcessorWindowController()
    ...
    def setPromptFromAudio(self, audio_data):
        ...
        if return_code == AudioReceiver.SUCCESS:
        ...
        elif return_code == AudioReceiver.UNSURE:
            return
